...
export interface ListWorkflowFormGroupData {
  data: Workflow[]
  last_page: number
  page: number
  record_count: number
...
export interface PutWorkflowFormGroupData {
  data: Workflow[]
  last_page: number
  page: number
  record_count: number
...
export interface PostWorkflowFormGroupData {
  data: Workflow[]
  last_page: number
  page: number
  record_count: number
...
export interface DeleteWorkflowFormGroupData {
  data: Workflow[]
  last_page: number
  page: number
  record_count: number
