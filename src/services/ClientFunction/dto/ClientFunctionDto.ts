...
export interface ListClientFunctionData {
  data: Workflow[]
  last_page: number
  page: number
  record_count: number
...
export interface PutClientFunctionData {
  data: Workflow[]
  last_page: number
  page: number
  record_count: number
...
export interface PostClientFunctionData {
  data: Workflow[]
  last_page: number
  page: number
  record_count: number
...
export interface DeleteClientFunctionData {
  data: Workflow[]
  last_page: number
  page: number
  record_count: number
