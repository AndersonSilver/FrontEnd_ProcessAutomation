...
export interface ListWorkflowStepFormData {
  data: Workflow[]
  last_page: number
  page: number
  record_count: number
...
export interface PutWorkflowStepFormData {
  data: Workflow[]
  last_page: number
  page: number
  record_count: number
...
export interface PostWorkflowStepFormData {
  data: Workflow[]
  last_page: number
  page: number
  record_count: number
...
export interface DeleteWorkflowStepFormData {
  data: Workflow[]
  last_page: number
  page: number
  record_count: number
