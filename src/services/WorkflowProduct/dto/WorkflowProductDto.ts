...
export interface ListWorkflowProductData {
  data: Workflow[]
  last_page: number
  page: number
  record_count: number
...
export interface PutWorkflowProductData {
  data: Workflow[]
  last_page: number
  page: number
  record_count: number
...
export interface PostWorkflowProductData {
  data: Workflow[]
  last_page: number
  page: number
  record_count: number
...
export interface DeleteWorkflowProductData {
  data: Workflow[]
  last_page: number
  page: number
  record_count: number
