...
export interface ListWorkflowGroupItemData {
  data: Workflow[]
  last_page: number
  page: number
  record_count: number
...
export interface PutWorkflowGroupItemData {
  data: Workflow[]
  last_page: number
  page: number
  record_count: number
...
export interface PostWorkflowGroupItemData {
  data: Workflow[]
  last_page: number
  page: number
  record_count: number
...
export interface DeleteWorkflowGroupItemData {
  data: Workflow[]
  last_page: number
  page: number
  record_count: number
