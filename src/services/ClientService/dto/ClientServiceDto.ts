...
export interface ListClientServiceData {
  data: Workflow[]
  last_page: number
  page: number
  record_count: number
...
export interface PutClientServiceData {
  data: Workflow[]
  last_page: number
  page: number
  record_count: number
...
export interface PostClientServiceData {
  data: Workflow[]
  last_page: number
  page: number
  record_count: number
...
export interface DeleteClientServiceData {
  data: Workflow[]
  last_page: number
  page: number
  record_count: number
